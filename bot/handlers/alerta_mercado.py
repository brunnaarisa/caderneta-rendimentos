...
async def alerta_mercado_cmd(
    ...
    await update.message.reply_text(
        ...
        "📉 **OPORTUNIDADE DE COMPRA** quando:\n"
        "• Cripto cai mais de 5% em 24h\n"
        "• RSI < 25 (sobrevendido — possível fundo)\n"
        "• Índice de Medo < 20 (pânico no mercado)\n\n"
        "📈 **SINAL DE VENDA** quando:\n"
        "• Cripto sobe mais de 15% em 24h\n"
        "• RSI > 80 (sobrecomprado — mercado pode corrigir)\n"
        "• Índice de Ganância > 80 (euforia — cautela)\n\n"
